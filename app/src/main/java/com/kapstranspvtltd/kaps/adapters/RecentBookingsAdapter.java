...
public class RecentBookingsAdapter extends RecyclerView.Adapter<RecentBookingsAdapter.BookingViewHolder> {
    ...
    public RecentBookingsAdapter(Context context, OnBookingClickListener listener) {
    ...
    class BookingViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Booking booking) {
            ...
            System.out.println("bookingTiming::"+bookingTiming);
            bookingTiming = formatDateTime(bookingTiming);
            binding.txtDate.setText(bookingTiming);
            binding.txtType.setText(booking.getVehicle_name());
