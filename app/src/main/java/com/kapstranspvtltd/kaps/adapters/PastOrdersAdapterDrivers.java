...
public class PastOrdersAdapterDrivers extends RecyclerView.Adapter<PastOrdersAdapterDrivers.OrderViewHolder> {
    private Context context;
    private List<AllDriverOrdersModel> orders = new ArrayList<>();
    private OnOrderClickListener listener;


    public interface OnOrderClickListener {
        void onOrderClick(AllDriverOrdersModel order, int position);
    }

    public PastOrdersAdapterDrivers(Context context, OnOrderClickListener listener) {
        this.context = context;
        this.listener = listener;
    }

    public void setOrders(List<AllDriverOrdersModel> orders) {
        this.orders = orders;
    ...
    class OrderViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(AllDriverOrdersModel order) {
