...
import com.kapstranspvtltd.kaps.driver_customer_app.activities.models.DriverBookingDetails;
...
public class DriverOngoingBookingDetailsActivity extends AppCompatActivity implements OnMapReadyCallback {
    private ActivityDriverOngoingBookingBinding binding;
    ...
    private DriverBookingDetails bookingDetails;
...
//        dialog.show();
    ...
    private void fetchBookingDetails() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                APIClient.baseUrl + "other_driver_booking_details_live_track",
                params,
                response -> {
                    try {
    ...
    private DriverBookingDetails parseBookingDetails(JSONObject result) throws JSONException {
        DriverBookingDetails details = new DriverBookingDetails();
    ...
    private void fetchDriverLocation() {
        ...
        String url = APIClient.baseUrl + "other_driver_current_location";
