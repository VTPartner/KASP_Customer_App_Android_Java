package com.kapstranspvtltd.kaps.driver_customer_app.activities.models;
...
public class DriverOrderDetails {
    ...
    public static DriverOrderDetails fromJson(JSONObject json) throws JSONException {
        DriverOrderDetails details = new DriverOrderDetails();
