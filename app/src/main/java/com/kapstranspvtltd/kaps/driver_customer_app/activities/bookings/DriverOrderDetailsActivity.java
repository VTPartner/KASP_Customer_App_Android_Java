...
import com.kapstranspvtltd.kaps.databinding.ActivityDriverOrderDetailsBinding;
import com.kapstranspvtltd.kaps.driver_customer_app.activities.models.DriverOrderDetails;
...
public class DriverOrderDetailsActivity  extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private DriverOrderDetails orderDetails;
...
//        EditText commentBox = sheetView.findViewById(R.id.commentBox);
    ...
    private void submitRating(BottomSheetDialog dialog, int rating, String comment) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                APIClient.baseUrl + "save_other_driver_order_ratings",
                params,
                response -> {
...
//    }
    ...
    private void fetchOrderDetails(String orderId) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
               APIClient.baseUrl + "other_driver_order_details",
                params,
                response -> {
                    try {
                        JSONObject result = response.getJSONArray("results").getJSONObject(0);
                        orderDetails = DriverOrderDetails.fromJson(result);
...
//        binding.txtStatus.setText(orderDetails.getBookingStatus());
        binding.txtStatus.setText("Ride Completed Successfully");
