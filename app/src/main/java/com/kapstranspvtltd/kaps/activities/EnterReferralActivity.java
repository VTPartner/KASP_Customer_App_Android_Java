...
public class EnterReferralActivity extends AppCompatActivity {

    private static final String TAG = "EnterReferralActivity";
    private static final String API_VALIDATE_REFERRAL = APIClient.baseUrl+"validate_referral_code";
    private static final String API_APPLY_REFERRAL = APIClient.baseUrl+"apply_referral_code";
    ...
    private void initializeViews() {
        ...
        getBonusTextView.setText("Get ₹"+signUpBonusCustomerApp+" bonus in your wallet instantly");
        subTitleTextView.setText("Enter your friend's referral code to get ₹"+signUpBonusCustomerApp+" bonus!");
    }
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                if (response.getString("status").equals("success")) {
                                    ...
                                    Toast.makeText(EnterReferralActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                                }
                            } catch (JSONException e) {
                                Log.e(TAG, "JSON parsing error: " + e.getMessage());
                                Toast.makeText(EnterReferralActivity.this, "Error processing response", Toast.LENGTH_SHORT).show();
                            }
                        }
                    },
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            showLoading(false, "");
                            Log.e(TAG, "Volley error: " + error.getMessage());
                            Toast.makeText(EnterReferralActivity.this, "Network error. Please try again.", Toast.LENGTH_SHORT).show();
                        }
                    }
            );
    ...
    public static void startActivity(android.content.Context context) {
        Intent intent = new Intent(context, EnterReferralActivity.class);
