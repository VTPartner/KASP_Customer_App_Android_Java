...
public class HandymanOrderDetailsActivity extends AppCompatActivity implements OnMapReadyCallback {
    private ActivityHandymanOrderDetailsBinding binding;
...
//    private PDFGenerator pdfGenerator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHandymanOrderDetailsBinding.inflate(getLayoutInflater());
...
//        EditText commentBox = sheetView.findViewById(R.id.commentBox);
    ...
    private void submitRating(BottomSheetDialog dialog, int rating, String comment) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                APIClient.baseUrl + "save_handyman_order_ratings",
                params,
                response -> {
...
//    }
    ...
    private void fetchOrderDetails(String orderId) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                APIClient.baseUrl + "handyman_order_details",
                params,
                response -> {
                    try {
