...
//        if (currentTime - lastFetchTime < 100) { // 10 seconds in milliseconds
            // Load from cache
            loadFromCache();
...
//        try {
//            System.out.println("image imageUrl::"+imageUrl);
//            Glide.with(context)
//                    .load(imageUrl)
//                    .preload();
//        } catch (Exception e) {
...
private void preloadImage(Context context, String imageUrl) {
    try {
        ...
        Log.e("GlidePreload", "Error preloading image: " + e.getMessage());
    }
}
    ...
    private void loadFromCache() {
        ...
        System.out.println("cachedContent::"+cachedContent);
