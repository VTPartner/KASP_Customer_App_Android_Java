...
import com.kapstranspvtltd.kaps.databinding.ItemServiceBookingBinding;
...
public class RecentServiceBookingsAdapter extends RecyclerView.Adapter<RecentServiceBookingsAdapter.BookingViewHolder> {
    private Context context;
    private List<AllServiceBookingsModel> bookings = new ArrayList<>();
    private RecentServiceBookingsAdapter.OnBookingClickListener listener;

    public interface OnBookingClickListener {
        void onBookingClick(AllServiceBookingsModel booking, int position);
    }

    public RecentServiceBookingsAdapter(Context context, RecentServiceBookingsAdapter.OnBookingClickListener listener) {
        this.context = context;
        this.listener = listener;
    }

    public void setBookings(List<AllServiceBookingsModel> bookings) {
    ...
    @NonNull
    @Override
    public RecentServiceBookingsAdapter.BookingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemServiceBookingBinding binding = ItemServiceBookingBinding.inflate(
                LayoutInflater.from(parent.getContext()), parent, false);
        return new RecentServiceBookingsAdapter.BookingViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull RecentServiceBookingsAdapter.BookingViewHolder holder, int position) {
    ...
    class BookingViewHolder extends RecyclerView.ViewHolder {
        private ItemServiceBookingBinding binding;

        BookingViewHolder(ItemServiceBookingBinding binding) {
            super(binding.getRoot());
            this.binding = binding;
        }

        void bind(AllServiceBookingsModel booking) {
