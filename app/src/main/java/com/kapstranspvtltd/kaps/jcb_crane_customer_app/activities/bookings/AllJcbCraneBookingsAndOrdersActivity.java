...
import com.kapstranspvtltd.kaps.databinding.ActivityAllJcbCraneBookingsAndOrdersBinding;
import com.kapstranspvtltd.kaps.handyman_customer_app.activities.bookings.HandymanOngoingBookingDetailsActivity;
import com.kapstranspvtltd.kaps.handyman_customer_app.activities.bookings.HandymanOrderDetailsActivity;
...
public class AllJcbCraneBookingsAndOrdersActivity extends AppCompatActivity {

    ActivityAllJcbCraneBookingsAndOrdersBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAllJcbCraneBookingsAndOrdersBinding.inflate(getLayoutInflater());
    ...
    private void initViews() {
        ...
        pastAdapter = new PastServiceOrdersAdapter(this,
                (order, position) -> {
                    // Create intent to launch TripDetailsActivity
                    Intent intent = new Intent(this, JcbCraneOrderDetailsActivity.class);
