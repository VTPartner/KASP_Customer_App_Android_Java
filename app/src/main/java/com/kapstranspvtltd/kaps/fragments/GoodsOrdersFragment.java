...
import com.kapstranspvtltd.kaps.databinding.FragmentGoodsOrdersBinding;
...
/**
 * create By Shaheed MacbookPro
 */
public class GoodsOrdersFragment extends Fragment {
    private FragmentGoodsOrdersBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGoodsOrdersBinding.inflate(inflater, container, false);
        initViews();
        fetchData();
    ...
    private void fetchRecentBookings() {
        ...
        String url = APIClient.baseUrl + "customers_all_bookings";
...
//                    showError(error.getMessage());
    ...
    private void fetchPastOrders() {
        ...
        String url = APIClient.baseUrl + "customers_all_orders";
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                AllGoodsOrders order = new AllGoodsOrders(
                                        ...
                                        json.getString("receiver_number"),
